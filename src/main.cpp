...
int main(int argc, char *argv[])
{
    ...
    // This seems to be bugged as it gives bad values for mouse movement.
    ...
    // Print errors, but don't react to them. This is because there is currently
    // a 500 error that is unaccounted for in SDL2.
